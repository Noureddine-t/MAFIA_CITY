class_name Hero_policewoman extends CharacterBody2D

const bulletPath = preload('res://assets/scenes/gameplay/bulllet_2.tscn')  # Balle spécifique à Hero2
...
func shoot_bullet():
	...
	var bullet_offset_right = Vector2(30, 20)
	var bullet_offset_left = Vector2(-30, 20)
...
func die() -> void:
	...
	UpdateAnimation()
	await get_tree().create_timer(1.0).timeout
	get_tree().change_scene_to_file("res://assets/scenes/gameover/Gameover.tscn")
	#queue_free()  
